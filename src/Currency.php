 ...
 *
 * This class is inherited from Sebastian Bergmann's "Money" project and is:
 * (c) Sebastian Bergmann <sebastian@phpunit.de>
 *
 * The class has been modified in larger parts to match the overall coding
...
class Currency {
	...
	public function __construct($currencyCode) {
		if (!isset(static::$_currencies[$currencyCode])) {
	...
	public function getDefaultFractionDigits() {
		return static::$_currencies[$this->_currencyCode]['default_fraction_digits'];
	}
	...
	public function getDisplayName() {
		return static::$_currencies[$this->_currencyCode]['display_name'];
	}
	...
	public function getNumericCode() {
		return static::$_currencies[$this->_currencyCode]['numeric_code'];
	}
	...
	public function getSubUnit() {
		return static::$_currencies[$this->_currencyCode]['sub_unit'];
	}
